...
const numberOfPeople = document.getElementById("peop");
const customTipPercentage = document.getElementById("cust");
const billTipAmount = document.getElementById("tipAmnt");
